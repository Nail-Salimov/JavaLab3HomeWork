...
public class FireDeliverCallback implements DeliverCallback {
    ...
    public FireDeliverCallback() {
        this.objectMapper = new ObjectMapper();
    }

    public FireDeliverCallback(String src, String dest, String russianFont) {
        this.objectMapper = new ObjectMapper();
        this.src = src;
        this.dest = dest;
    ...
    public String createFileName(DocumentRequest documentRequest) {
        return "fire_" + documentRequest.getSurname() + "_" + documentRequest.getName() + "_" + UUID.randomUUID().toString() + ".pdf";
    }
}
